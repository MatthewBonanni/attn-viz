    ...
    return {
        ...
        ops: [
            ...
            { id: 'view_out',type: 'reshape', inputs: ['attn_head'],         output: 'ctx',      label: 'View',
              desc: `View heads as flat: [B, n_h, S_q, d_h] → [B, S_q, D]. Merges n_h=${n_h} × d_h=${d_h} = D=${D}. Zero-cost metadata operation.` },
    ...
    return {
        ...
        ops: [
            ...
            { id: 'view_out',     type: 'reshape',    inputs: ['ctx_head'],          output: 'ctx',      label: 'View',
              desc: `View heads as flat: [B, n_h, S_q, d_h] → [B, S_q, D]. Zero-cost metadata operation.` },
            { id: 'out_proj',     type: 'matmul',     inputs: ['ctx','W_O'],         output: 'out',      label: 'Linear',
              desc: `Output projection: [B, S_q, D] @ [D, D] → [B, S_q, D] via Wo. This mixes information across heads.` },
        ],
        groups: [
