...
export function mlaUpprojGraph(p) {
    ...
    return {
        ...
        tensors: [
            ...
            { id: 's_content', shape: [B, n_h, S, S],    label: "Q'Kᵀ",   stage: 6, row: 0, color: '#9b59b6', dimNames: ['B','n_h','S','S'],
            ...
            { id: 'scores', shape: [B, n_h, S, S],       label: 'Scores', stage: 7, row: 0, color: '#9b59b6', dimNames: ['B','n_h','S','S'],
              desc: `Combined attention scores = (Q' @ K^T) + (q_r' @ k_r'^T). Content similarity plus relative position.` },
            { id: 'mask',   shape: [S, S],                label: 'Mask',   stage: 7, row: 1, color: '#1abc9c', dimNames: ['S','S'], type: 'mask',
              desc: 'Causal mask.' },
            { id: 'attn',   shape: [B, n_h, S, S],       label: 'Attn',   stage: 9, row: 0, color: '#9b59b6', dimNames: ['B','n_h','S','S'],
...
export function mlaAbsorbedGraph(p) {
    ...
    return {
        ...
        tensors: [
            ...
            // Projected queries
            { id: 'q_lat',    shape: [B, n_h, S, d_c],     label: "q'",     stage: 4, row: 1, color: '#e74c3c', dimNames: ['B','n_h','S','d_c'],
